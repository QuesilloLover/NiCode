...
export default function Component() {
  const user = {
    ...
    xpToNextLevel: 10000,
    badges: [
      { name: "La mera yuca de la sopa", icon: <Trophy className="h-4 w-4" /> },
      { name: "una fumada salvaje", icon: <Swords className="h-4 w-4" /> },
      { name: "foki caballo bayo", icon: <ThumbsUp className="h-4 w-4" /> },
    ],
    matchHistory: [
